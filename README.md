...
#### EditInfo <!-- omit in toc -->

- Email, Password, Username 수정

#### DetailTransaction <!-- omit in toc -->
...
#### [Firebase](https://firebase.google.com/?gclid=Cj0KCQjwnqH7BRDdARIsACTSAdvm5eXGNNGs4GnD6Y-d-s90OHcZ29NE_969X2J50lyWhQcgIZ364h8aAornEALw_wcB) <!-- omit in toc -->

#### [GiftChat](https://github.com/FaridSafi/react-native-gifted-chat) <!-- omit in toc -->

#### [Dialogflow](https://dialogflow.cloud.google.com/) <!-- omit in toc -->

#### [Kakao Maps API](https://apis.map.kakao.com/) <!-- omit in toc -->

#### [Google Geocoding API](https://developers.google.com/maps/documentation/geocoding/overview) <!-- omit in toc -->

#### [Mobx](https://mobx.js.org/README.html) <!-- omit in toc -->

#### [emotion/native](https://emotion.sh/docs/@emotion/native) <!-- omit in toc -->

#### [ESLint Airbnb - Typescript](https://github.com/iamturns/eslint-config-airbnb-typescript) <!-- omit in toc -->

### 🚧 더 개선하거나 추가하고 싶은 기능이 있어요!
...
<img src="./.github/assets/staff/wonhyeong.jpg" width="300">
